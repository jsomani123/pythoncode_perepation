...
if(length_of_land<100):
    logging.info(f"we can not build  4bhk house in this ")
    if(length_of_land>80):
        logging.info(f"you can build a 3 bhk ")
    else:
        logging.info(f"you land does not have enough space to build a house ")
elif length_of_land>500 :
    logging.info(f"we will help you to design and provide extra seervice also") 
#logging.INFO(f"{type(length_of_land)}")
else:
    logging.info(f"we will help you to design ")
